            ...
            if (checkIfOwnedOnSteam(name, line)) {
                ...
                if (!/Taken by/.test(line)) {
                    $elem.html(
                        $elem.html().replace(
                            name,
                            "<a data-modbotline='" + line + "'title='Click here to send PM' href='" + modBotUrl + "'><span class='sendPMFlag'> MESSAGE &nbsp;&nbsp</span></a>" +
                            "<span class='sendPMText'>" + "<a class='checkShop'" + 
                            "title='Click here to search store' " +
